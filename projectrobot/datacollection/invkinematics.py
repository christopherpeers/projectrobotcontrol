...
def kinematics():
	...
	print "###########################################"
	motorangle1 = -80.0 #deg
	motorangle2 = 24.0 #deg
	n = 0 #error counter
	end = 0
	data = [0,0,0,0]
	debug = [0,0,0,0,0,0,0,0,0]

	while(end == 0): #Changed to 1 from 180 to make testing faster
...
################################################
		...
		#print math.degrees(motor1), math.degrees(motor2)
		print motor1, motor2
		#30,68
	...
	#np.savetxt("kinematicsdata.csv", data, delimiter=",")
